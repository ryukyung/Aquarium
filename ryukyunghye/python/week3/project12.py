'''PROJECT12 엑셀의 정보를 불러와 수료증 자동 생성
엑셀에 저장된 수료 명단 정보를 불러와 워드로 수료증을 자동 생성하고 PDF로 변환하는 프로그램을 만들어 봅니다.'''
...
load_wb = load_workbook(r'week3\project12_수료증명단.xlsx')
...
for i in range(len(name_list)):
    doc = docx.Document(r'week3\project12_수료증양식.docx')
    ...
    doc.save('week3\\'+name_list[i]+'.docx')
    convert('week3\\'+name_list[i]+'.docx',
            'week\\'+name_list[i]+'.pdf')
